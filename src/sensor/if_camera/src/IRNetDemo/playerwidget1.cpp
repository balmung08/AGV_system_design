...
void PlayerWidget::OnVideoShow(uchar* rgbData, int w, int h, int macIndex,int type){    
    ...
    // IRNet::IRPointInfo *minPoint;
        ...
        // rect_Xcenter =1;
        // int rect_Ycenter =1;
        // std::cout<<"xcenter:  "<<rect_Xcenter<<"  "<<rect_Ycenter<<std::endl;
        // shift_from_center = 50;
        ...
        rect_analysis.points[0].x = 380-50;
        rect_analysis.points[0].y = 280-50;
        rect_analysis.points[1].x = 380+50;
        rect_analysis.points[1].y = 280+50;
