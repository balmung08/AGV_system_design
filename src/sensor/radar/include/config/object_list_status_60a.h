...
class ObjectListStatus60A
{
 public:
  ...
  int num_of_objects(const uint8_t* bytes, int32_t length) const;

  int meas_counter(const uint8_t* bytes, int32_t length) const;

  int interface_version(const uint8_t* bytes, int32_t length) const;
};
