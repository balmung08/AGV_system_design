...
public:
    ...
    ParamServer()
    {
        ...
        nh.param<float>("lio_sam/globalMapLeafSize", globalMapLeafSize, 0.5);
        nh.param<std::string>("lio_sam/map_path", map_path, "/map_path");
        ...
        nh.param<double>("lio_sam/initial_yawAngle", initial_yawAngle);
        ...
        extQRPY = Eigen::Quaterniond(extRPY).normalized().inverse();
